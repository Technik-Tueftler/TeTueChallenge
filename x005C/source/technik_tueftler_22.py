...
def set_battleship_in_direction(row: int, col: int, size: int, func_started: bool, ship_sign: str, direction: str,
    ...
    if direction == Direction.East:
        ...
        set_battleship_in_direction(row, col + 1, size, True, ship_sign, Direction.East, battle_field)
    elif direction == Direction.South:
        battle_field[row + 1][col] = ship_sign
        set_battleship_in_direction(row + 1, col, size, True, ship_sign, Direction.South, battle_field)
